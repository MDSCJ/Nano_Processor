----------------------------------------------------------------------------------
-- Module Name: RCA_3_gr_46 - Behavioral
----------------------------------------------------------------------------------
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
use work.Adders_gr_46.FA_gr_46;

entity RCA_3_gr_46 is
...
architecture Behavioral of RCA_3_gr_46 is
...
begin
    ...
    FAs : for i in 0 to N-1 generate
        FA_inst : FA_gr_46
            port map (A => A(i), B => B(i), C_in => Carry_In(i), S => S(i), C_Out => Carry_Out(i));
